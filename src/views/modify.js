...
class Modify extends Component {
    ...
    componentDidMount() {
        ...
        getSingleMedia(id).then(pic => {
            console.log("Pic: ",pic);
            this.setState({fileUrl: pic.filename});
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <img src={this.mediaUrl + this.state.fileUrl} alt={this.state.file.title} style={{'width': '20%'}} onChange={this.handleFileChange}/>
                <ValidatorForm instantValidate={false}
                    ...
                    <Button type="submit" variant="contained"
                            color="primary">Update&nbsp;{this.state.loading &&
